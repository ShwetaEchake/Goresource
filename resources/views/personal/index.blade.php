...
<!-------------------- Buttons End -------------------------------->
        ...
        <table class="table table-hover" id="">
            ...
            <tbody>
                ...
                if(isset($candidate_documentPhoto)){ ?>
                ...
                <?php } ?>
				 ...
				 $experience_detail= DB::table('personal')
                     ...
                     <td>
                     <p>
                       <a href='personal/<?php echo $candidate->candidate_id ?>/' target='_blank' style='color:black;font-weight:600' class='' title='Candidate Detail'> <u>{{ $candidate->name }}</u> {{ $candidate->middle_name}} {{ $candidate->last_name}}
                       </a>
                     </p>
           ...
           if(check == true){
                   ...
                   //document.getElementById("multipleids").value = join_selected_values;
                     ...
                     $.ajax({
                             ...
                             url: "{{ url('Personalexport') }}?id=" + selected_values,
