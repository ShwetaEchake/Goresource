...
<div class="card">
    <div class="card-header">
        <h3 class="card-title "><i class="fa fa-paw mr-1"></i>Users</h3>
          @if(auth()->user()->user_type!='User')
            <div class="card-tools">
                <a href="{{ route('personal.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add Users</a>
            </div>
          @endif
      </div>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title "><i class="fa fa-paw mr-1"></i>
            ...
            <div class="card-tools">
                <a href="{{ route('user.create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create User</a>
            </div>
                   ...
                   @forelse ($users as $user)
                    <tr>
                        ...
                        <td>{{ $user->email }}</td>
                         <td>{{ $user->phone }}</td>
                        <td>
                            <span class="badge badge-info" style="padding:5px;">{{ $user->user_type }}</span>
                        </td>
                    ...
                    <div class="row">
                        <a class="btn btn-sm btn-primary"  href="{{ route('user.show',$user->id) }}"><i class="fa fa-eye"></i> </a>&nbsp;
                        
                       <a class="btn btn-sm btn-warning" href="{{ route('user.edit',$user->id) }}"><i class="fa fa-edit"></i> </a>&nbsp;


                        <form action="{{ route('user.destroy',$user->id) }}" method="POST" onclick="return confirm(' Are you sure you want to Delete?')">
