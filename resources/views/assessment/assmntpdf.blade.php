...
<body>
     ...
     {{--<?php $data=DB::table('assessment')->where('assessment_id',$_GET['id'])->first(); ?>--}}
        ...
        <?php  $data=DB::table('assessment')
                ->leftjoin('personal','personal.candidate_id','assessment.candidate_id')
                ->leftjoin('job_applied','job_applied.candidate_id','assessment.candidate_id')
                ...
                ->where('assessment.location_id',$locationID)
                ->where('assessment.job_id',$jobID)
                ->where('assessment_id',$assmnt_id)
                ->first(); 
        ?>
        ...
        <table class="c17" width="100%">
            ...
            <tr class="c62">
                <td class="c24" colspan="6" rowspan="1">
                 <p class="c25 c46">
                    <span>
                        <img alt="" src="{{public_path()}}/img/image1.png" style="margin-top:10px;" height="60px;">
                   </span>
                   ...
                   <span > 
                   <img alt="" src="{{public_path()}}/img/image2.png" style=" margin-top:10px;margin-left:300px;" height="60px;">
    ...
    <td class="c23" colspan="1" rowspan="5">
        <p class="c25"><span class="c12 c77">Attached 1 pc. 2&rdquo; x 2&rdquo;</span></p>
        <p class="c25"><span class="c77 c12">colored photo</span></p>
    </td>
</tr>

<tr class="c49">
    <td class="c90" colspan="1" rowspan="1">
        <p class="c5"><span class="c61">GO ID#:{{$data->branch_name}}</span></p>
    </td><td class="c63" colspan="5" rowspan="1">
        <p class="c5"><span class="c61">&nbsp;Interviewed by:{{$data->interviewer_name}}</span></p>
    </td>
</tr>

<tr class="c75">
    <td class="c66" colspan="1" rowspan="1">
        <p class="c5"><span class="c8">Date &amp; Time Applied</span></p>
    </td>
    <td class="c54" colspan="3" rowspan="1">
        <p class="c3"><span class="c8">{{$data->created_at}}</span></p>
    </td>
    <td class="c9" colspan="1" rowspan="1">
        <p class="c5"><span class="c8">Ref.:{{$data->reffer_by}}</span></p>
    </td>
...
<tr class="c73">
    <td class="c43" colspan="2" rowspan="1">
        <p class="c5"><span class="c14">POSITION OFFERED:{{$data->category_name}}</span></p>
    </td>
    <td class="c15" colspan="2" rowspan="1">
        <p class="c5"><span class="c50">Proj. Ref:</span></p>
        <p class="c3"><span class="c8"></span></p>
    </td>

    <td class="c42" colspan="2" rowspan="1">
        <p class="c5"><span class="c14">Country Preferred:</span></p>
    </td>
</tr>
<tr class="c67">
    <td class="c68" colspan="3" rowspan="1">
        <p class="c5"><span class="c1">Position Applied: 1</span>
            <span class="c22">st</span>
            <span class="c1 c12">&nbsp;Choice</span>
        </p>
    </td>

        <td class="c84" colspan="3" rowspan="1">
            <p class="c5">
                <span class="c1">Position Applied: 2</span>
                <span class="c22">nd</span>
                <span class="c1 c12">&nbsp;Choice</span>
            </p>
        </td>
    </tr>
        ...
        <tbody>
            <tr class="c7">
                <td class="c6" colspan="1" rowspan="1">
                    <p class="c5"><span class="c30">APPLICANT&rsquo;S NAME</span></p>
                </td>
            ...
            <tr class="c59">
                <td class="c40" colspan="1" rowspan="1">
                    <p class="c5"><span class="c50">PP Number:</span></p>
                </td>
                <td class="c41" colspan="1" rowspan="1">
                    <p class="c5"><span class="c50">Issue Date:</span></p>
                </td>
                <td class="c85" colspan="1" rowspan="1">
                    <p class="c5">
                        <span class="c50">Expiry Date:</span>
                    </p>
                </td>
            </tr>
        </tbody>
    ...
    <p class="c3"><span class="c1 c12"></span></p>
    <a id="t.cf8b60af333b9d8ecfbe13dc598c3fa2ace3bec7"></a><a id="t.2"></a>
    ...
    <table class="c17" width="100%">
        ...
        <tr class="c29">
            ...
            <p class="c5"><span class="c61">ASSESSMENT</span></p>
           </td>
       </tr>
    <tr class="c26">
    ...
    <tr class="c26">
        ...
        <tr class="c26">
            <td class="c81" colspan="1" rowspan="1">
                <p class="c25"><span class="c1 c12">1=22-40 Ineffective</span></p>
            </td>
            <td class="c57" colspan="2" rowspan="1">
                <p class="c25"><span class="c1 c12">2=41-59 NEEDS IMPROVEMENT</span></p>
            </td>
                <td class="c64" colspan="2" rowspan="1"><p class="c25"><span class="c1 c12">3=60-78 Good</span></p></td>
                <td class="c86" colspan="2" rowspan="1"><p class="c25"><span class="c1 c12">4=79-97 Very Good</span></p></td>
                <td class="c52" colspan="1" rowspan="1"><p class="c25"><span class="c1 c12">5=98-100 EXCELLENT</span></p></td>
        </tr>
